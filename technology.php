...
$read_query="SELECT * FROM `blogs` WHERE `blog_file`='$blog' AND `blog_category`='technology'";
...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left w3-text-white" style="display:none;background-color:rgb(51,63,80);" id="mySidebar">
  ...
  <?php 
  $content_query="SELECT * FROM `blogs` WHERE `blog_category`='technology'";
  $content_run=mysqli_query($blogs_con,$content_query);

  if(mysqli_num_rows($content_run)<1)
{
    echo "No data found!";
}
else
...
<div style="background-color:white;">
  <button id="openNav" class="w3-white w3-round-large w3-border w3-hover-shadow" onclick="w3_open()"  style="color:rgb(51,63,80);"><img src="images/blogs/bar1.png" alt="menu" width="50px" height="50px"></button>
