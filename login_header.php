...
<div class="w3-top">
  ...
  <a href="community" class="w3-bar-item w3-button w3-text-grey w3-hover-grey w3-round-large" onclick="toggleFunction()"><i class="fa fa-group"></i> COMMUNITY</a>
    </div>
</div>
<br>
<br>
...
<div class="w3-container">
      <div class="w3-dropdown-click w3-right">
        <div id="profile_portal" class="w3-dropdown-content w3-bar-block" style="right:0">
          <!-- login start -->
        <div class="w3-modal-content w3-border w3-round-large" style="width:300px;">
